...
<body>
	<div id="header">
		...
		<form method="get">
			<table id="question"><tr><td> If this "<?php echo $cat;?>" page:<input type="radio" value="yes" name="option">Yes <input type="radio" value="no" name="option">No</td><td><input class="submit" type="submit">
